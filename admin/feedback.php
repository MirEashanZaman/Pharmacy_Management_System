...
if (isset($_GET['delete'])) {
    ...
    $conn->query("DELETE FROM feedback WHERE id=$fid");
    header("Location: feedback.php?deleted=1");
    exit;
}

$feedbacks = $conn->query("SELECT f.*, u.name as user_name FROM feedback f LEFT JOIN users u ON f.user_id=u.id ORDER BY f.created_at DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container">
    ...
    <?php if(isset($_GET['deleted'])): ?><div class="alert alert-success">✅ Feedback deleted.</div><?php endif; ?>
        ...
        <div class="card-body">
            <div class="d-flex justify-between align-center mb-2">
                ...
                <div class="d-flex align-center gap-1">
                    ...
                    <a href="?delete=<?= $fb['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Delete this feedback?')">🗑️</a>
                </div>
            </div>
            <?php if($fb['subject']): ?>
